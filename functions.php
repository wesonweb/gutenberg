...
add_image_size( 'user', '50', '50', true); //crops
...
*/
	function vanilla_menus() {
		$locations = array (
			'primary' 	=> esc_html( 'Main navigation' ),
			'secondary' => esc_html( 'Footer navigation' )
		);
...
function vanilla_register_scripts() {
	wp_enqueue_script( 
	...
	wp_enqueue_script( 
	'starter-theme-skip-link-focus-fix', 
...
add_action( 'wp_enqueue_scripts', 'vanilla_register_scripts' );
...
add_theme_support( 
	'custom-background', 
	apply_filters( 'starter_theme_custom_background_args', 
	array(
...
*/
	...
	if( function_exists('acf_add_options_page') ) {
		...
		acf_add_options_sub_page(array(
			'page_title' 	=> 'footer company info',
			'menu_title'	=> 'footer company info',
			'parent_slug'	=> 'global-general-settings',
		));
}

/*[-- CUSTOM CHANGES TO WORDPRESS  --] */
//require(get_template_directory().'/function-templates/custom-posts.php');
// custom gutengberg blocks
...
/*
*	Import custom WordPress filters
*/
require get_template_directory().'/function-templates/wordpress-filters.php';
